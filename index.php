<html>
    ...
    <body>
        ...
        <nav>
            <hr width ="50%">
            <a href ="index.php"><i>Play new Song</i></a>
            <a href = "Info.php">Song Information</a>
        </nav>
        <!--num = rand(1,3);-->
        <!--num = rand (0,3);-->
    ...
    play();
        ...
        function playStudy($num, $x, $y)
        {
            echo "<h1>You are listening to the Study playList!</h1> </br> </br>";
            $pics = array("bridge.jpg", "buck-full-moon.jpg","cherryBlossem.jpg","korea.jpg","lowTides.jpg","paris2.jpg","rain.png","snow.png","waterfall.gif");
            ...
            echo '<div class = "pics"><img src="pics/'.$pics[$y].'"></div>';
